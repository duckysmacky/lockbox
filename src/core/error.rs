...
pub enum Error {
    ...
    InvalidDataError(InvalidDataErrorKind),
...
impl Error {
    ...
    pub fn should_exit(&self) -> bool {
        match self {
            ...
            Error::InvalidDataError(_) => false,
...
impl Display for Error {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Error::InvalidDataError(e) => write!(f, "Invalid data: {}", e),
...
macro_rules! err_cmp {
    ...
    ($err:tt, $err_type:ident, $err_kind:ident) => {
        {
            use paste::paste;
            use crate::core::error::Error;
...
mod tests {
    ...
    fn test_new_err_macro() {
        ...
        let msg_err = new_err!(InvalidDataError: InvalidHexNumber, "placeholder");
        assert!(err_cmp!(msg_err, InvalidDataError, InvalidHexNumber()));
    }
}